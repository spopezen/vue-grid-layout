...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"3e712485-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridLayout.vue?vue&type=template&id=41fbafae&
var GridLayoutvue_type_template_id_41fbafae_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"item",staticClass:"vue-grid-layout",style:(_vm.mergedStyle)},[_vm._t("default"),_c('grid-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.isDragging),expression:"isDragging"}],staticClass:"vue-grid-placeholder",attrs:{"x":_vm.placeholder.x,"y":_vm.placeholder.y,"w":_vm.placeholder.w,"h":_vm.placeholder.h,"i":_vm.placeholder.i}})],2)}
var GridLayoutvue_type_template_id_41fbafae_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/GridLayout.vue?vue&type=template&id=41fbafae&
...
/* harmony default export */ var GridLayoutvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      localLayout: this.layout.map(function (item) {
  ...
  watch: {
    ...
    layout: function layout(val) {
      this.localLayout = val.map(function (item) {
        return JSON.parse(JSON.stringify(item));
      });
    },
    localLayout: function localLayout() {
      this.layoutUpdate();
    },
  ...
  methods: {
    layoutUpdate: function layoutUpdate() {
      if (this.localLayout !== undefined && this.originalLayout !== null) {
        if (this.localLayout.length !== this.originalLayout.length) {
          ...
          var diff = this.findDifference(this.localLayout, this.originalLayout);
    ...
    dragEvent: function dragEvent(eventName, id, x, y, h, w) {
      ...
      var l = getLayoutItem(this.localLayout, id); //GetLayoutItem sometimes returns null object
      ...
      compact(this.localLayout, this.verticalCompact); // needed because vue can't detect changes on array element properties
    ...
    resizeEvent: function resizeEvent(eventName, id, x, y, h, w) {
      var l = getLayoutItem(this.localLayout, id); //GetLayoutItem sometimes return null object
    ...
    responsiveGridLayout: function responsiveGridLayout() {
      ...
      var newCols = getColsFromBreakpoint(newBreakpoint, this.cols); // save actual localLayout in layouts

      if (this.lastBreakpoint != null && !this.layouts[this.lastBreakpoint]) this.layouts[this.lastBreakpoint] = cloneLayout(this.localLayout); // Find or generate a new localLayout.
...
var GridLayout_component = normalizeComponent(
  ...
  GridLayoutvue_type_template_id_41fbafae_render,
  GridLayoutvue_type_template_id_41fbafae_staticRenderFns,
  false,
  null,
  null,
  null
