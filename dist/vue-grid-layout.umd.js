...
/*: Layout*/
{
  ...
  console.log(l, x, y, isUserAction); // Short-circuit if nothing to do.
  //if (l.y === y && l.x === x) return layout;

  var movingUp = y && l.y > y;
  if (l.y + l.h >= maxRows) return layout; // This is quite a bit faster than extending the object
...
/*: Layout*/
{
  ...
  if (!!maxRows && itemToMove.y + itemToMove.h >= maxRows) {
    ...
    return moveElement(layout, itemToMove, undefined, itemToMove.y, false, maxRows, maxColumns); // return layout;
  }
  ...
  methods: {
    layoutUpdate: function layoutUpdate() {
      if (this.layout !== undefined && this.originalLayout !== null) {
        console.log("its updating the layout yo"); // if (!this.validateLayoutFn(this.layout)) {
    ...
    dragEvent: function dragEvent(eventName, id, x, y, h, w) {
      ...
      var newLayout = moveElement(this.layout, l, x, y, true, this.maxRows, this.colNum); // if (!this.validateLayoutFn(newLayout)) {
      ...
      compact(this.layout, this.verticalCompact); // if (!this.validateLayoutFn(this.layout)) {
      //     this.layout = this.originalLayout.slice();
      //     this.$emit("invalidLayout");
      // }
    ...
    resizeEvent: function resizeEvent(eventName, id, x, y, h, w) {
      ...
      l.h = h;
      l.w = w; // if (!this.validateLayoutFn(this.layout)) {
      //     this.layout = this.originalLayout;
      //     this.$emit("invalidLayout");
      //     return;
      // }
...
var GridLayout_component = normalizeComponent(
  ...
  GridLayoutvue_type_template_id_1e2ce478_render,
  GridLayoutvue_type_template_id_1e2ce478_staticRenderFns,
  false,
  null,
  null,
  null
